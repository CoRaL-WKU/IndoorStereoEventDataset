...
image_root = os.path.join(prefix, "datasets/Coral_Indoor_Datasets/ALL_Image_webcam")
image_root = os.path.join(prefix, "datasets/Coral_Indoor_Datasets/IndoorSteroDataset_finetune4/indoor4/train_RGB")
panoptic_json = os.path.join(prefix, "datasets/Coral_Indoor_Datasets/IndoorSteroDataset_finetune4/indoor4/annotations/panoptic_train_coral.json")
instances_json = os.path.join(prefix, "datasets/Coral_Indoor_Datasets/IndoorSteroDataset_finetune4/indoor4/annotations/instance_train.json")
panoptic_root = os.path.join(prefix, "Mask2Former/datasets/Coral_Indoor_Datasets/IndoorSteroDataset_finetune4/indoor4/annotations/panoptic_train_coral")
...
register_coco_panoptic(
    ...
    #sem_seg_root = os.path.join(prefix, "datasets/coco/panoptic_semseg_train"),
...
register_coco_panoptic(
    ...
    image_root = os.path.join(prefix, "datasets/Coral_Indoor_Datasets/IndoorSteroDataset_finetune4/indoor4/val_RGB"),
    panoptic_root = os.path.join(prefix, "datasets/Coral_Indoor_Datasets/IndoorSteroDataset_finetune4/indoor4/annotations/panoptic_val_coral"),
    panoptic_json = os.path.join(prefix, "datasets/Coral_Indoor_Datasets/IndoorSteroDataset_finetune4/indoor4/annotations/panoptic_val_coral.json"),
    #sem_seg_root = os.path.join(prefix, "datasets/coco/panoptic_semseg_train)",
    instances_json = os.path.join(prefix, "datasets/Coral_Indoor_Datasets/IndoorSteroDataset_finetune4/indoor4/annotations/instance_val.json")
)
